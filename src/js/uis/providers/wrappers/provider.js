export default class Provider extends HTMLElement {
  ...
  getServices = () => {
    return /* html */`
      <div class="services">
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="consultation" reviews="32894" average-review="4.7" name="Prescription Consultation" description="Expert consultation with licensed pharmacists for medication guidance and drug interactions." price="0" last="0"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="screening" reviews="894" average-review="3.7" name="Health Screening" description="Blood pressure monitoring, diabetes screening, and basic health assessments." price="25" last="13"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="vaccination" reviews="1200" average-review="4.8" name="Vaccination Services" description="Flu shots, COVID-19 vaccines, and other immunizations administered by certified professionals." price="45" last="70"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="medication" reviews="0" average-review="0" name="Medication Synchronization" description="Coordinate all your prescriptions to be ready on the same day for convenient pickup." price="0" last="60"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="delivery" reviews="79" average-review="3.5" name="Home Delivery" description="Free prescription delivery service within 5-mile radius, same-day delivery available." price="236" last="138"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="information" reviews="432" average-review="4.0" name="Drug Information" description="Comprehensive medication information, side effects, and drug interaction database access." price="0" last="0"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="emergency" reviews="100" average-review="4.5" name="24/7 Emergency Support" description="Round-the-clock emergency prescription services and urgent medication needs." price="40" last="32"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="insurance" reviews="6" average-review="5.0" name="Insurance Verification" description="Quick insurance verification and prior authorization assistance for prescriptions." price="0" last="0"></service-wrapper>
        <service-wrapper store-name="HealthCare Plus Pharmacy" kind="telehealth" reviews="200" average-review="4.9" name="Telehealth Consultation" description="Virtual consultations with healthcare professionals from the comfort of your home." price="30" last="50"></service-wrapper>
      </div>
    `;
  }
