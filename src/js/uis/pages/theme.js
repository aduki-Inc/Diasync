...
export default class SheetThemes extends HTMLElement {
  ...
  _getThemeCardHTML(id, theme) {
    ...
    return `
            <div class="theme-card ${isActive ? "active" : ""
                ...
                <div class="theme-preview" style="background: linear-gradient(135deg, ${theme.colors.primary
      }20, ${theme.colors.secondary}20)">
                    <div class="theme-colors">
                        <div class="color-dot" style="background: ${theme.colors.primary
      }"></div>
                        <div class="color-dot" style="background: ${theme.colors.secondary
      }"></div>
                        <div class="color-dot" style="background: ${theme.colors.accent
      }"></div>
                    </div>
  ...
  async applyTheme(themeId) {
    try {
      ...
      const targetCard = this.shadowObj.querySelector(
        `[data-theme="${themeId}"]`
      );
      if (targetCard) {
